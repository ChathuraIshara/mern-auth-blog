...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center text-center text-gray-800 mt-20'>
        ...
        <h1 className='flex items-center gap-3 text-xl sm:text-3xl font-medium mb-2'>Hey {userData? userData.name:'blogger'}<img src={assets.hand_wave} className='w-8 aspect-square'></img></h1>
        <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Welcome to Blogify</h2>
